    ...
    <div>
        ...
        <div v-for="(item,i) in comments" :key="i" class="author-title reply-father">
            ...
            <div class="icon-btn">
				...
				<span @click="del(item.id)"><i class="iconfont el-icon-delete"></i></span>
				<!-- todo -->
            </div>
            <div class="talk-box">
                <p>
            ...
            <div class="reply-box">
                <div v-for="(reply,j) in item.reply" :key="j" class="author-title">
                    ...
                    <div class="icon-btn">
						...
						<span @click="delReply(reply.id)"><i class="iconfont el-icon-delete"></i></span>
    ...
    data(){
            ...
            comments:[
                {
                    ...
                    comment:'这两个java文件虽然支持度很高，但是似乎没有多大依赖关系',
                    time:'2021年4月18日 18:43',
                    commentNum:2,
                    like:0,
                    inputShow:false,
                    reply:[
      ...
      //                   }
						// ,
                        {
                            ...
                            to:'xiaoliu',
                            toId:19870621,
                            comment:'我在开发过程中同样遇到了这个问题，管理员看一下',
                            time:'2021年4月18日 19:23',
                            commentNum:0,
                            like:0,
                            inputShow:false
